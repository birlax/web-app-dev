...
import com.birlax.indiantrader.domain.Constants;
...
public class PriceBandDetectionService {
     ...
     * @return
     */
    public List<PriceVolumnDelivery> detectPriceBand(String securitySymbol, Date startDate, Date endDate) {
        ...
        List<Pair<Double, Double>> ranges = Constants.getRanges(0, 8000, 100);
