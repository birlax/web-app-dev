...
public class IndicatorUtil {
    ...
    public static void printReport(Security security, Date resultDateOnOrAfter, boolean printHeader,
        ...
        for (int i = 0; i < priceVolumnDeliveries.size(); i++) {
            if (resultDateOnOrAfter.before(priceVolumnDeliveries.get(i).getTradeDate())) {
