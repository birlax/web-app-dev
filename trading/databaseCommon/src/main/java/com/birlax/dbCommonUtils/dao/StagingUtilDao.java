...
public class StagingUtilDao {
     ...
     * <br>
     * Note : Above is true even when fully qualified name from temp table is passed.<br> Postgres also does not have
     * concept for GTT (Global Temp Table) and I don't wan't to build one.<br>
     * <br>
