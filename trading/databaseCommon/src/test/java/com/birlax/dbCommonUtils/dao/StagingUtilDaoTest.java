...
public class StagingUtilDaoTest extends BaseIntegerationTest {
    ...
    public void testCreateTempStageTable() {
        ...
        assertTrue(databaseMetadataService.determineStringTypeColumns(tempTableName, insertColumnNames, true)
                .iterator().next() == true);
    ...
    public void testCreateTempStageTable1() {
        String tempTable = stagingUtilDao.createTempStageTable(createTableColumns, "trade.nse_historical_price_data");
        assertTrue(tempTable.contains("nse_historical_price"),
    ...
    public void testDummyStageRecordsWithEmptyRecord() {
        assertThrows(IllegalArgumentException.class,
                () -> stagingUtilDao.dummyStageRecords(createTableColumns, insertTableColumns, null,
                        "trade.nse_historical_price_data", Collections.emptyList()));
    ...
    public void testDummyStageRecordsWithRecord() {
        String tempTableName = stagingUtilDao.dummyStageRecords(createTableColumns, insertTableColumns, null,
                "trade.nse_historical_price_data", records);
