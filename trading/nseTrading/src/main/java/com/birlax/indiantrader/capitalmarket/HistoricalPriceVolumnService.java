...
//    }
    ...
    public void syncPriceVolumnDeliveryForAllSecuritiesSingleDay(String s) {

    }

    public void syncPriceVolumnDelivery(String symbol, LocalDate startDate, LocalDate endDate) {
