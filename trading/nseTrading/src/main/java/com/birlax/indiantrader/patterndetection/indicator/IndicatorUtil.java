...
public class IndicatorUtil {
    ...
    public static Direction[] getDirectionByLookBack(Double[] data, int lookBack, double threshold,
        ...
        for (; index < data.length; index++) {
            ...
            // Strictly Greater
            if (data[index] - data[index - 1] > threshold) {
                ups[index]++;
            }
            // Strictly Lower
    ...
    public static void printReport(Security sec, LocalDate resultDate, boolean printHeader, List<PriceVolumnDelivery> priceVolumnDeliveries, IndicatorResultHolder holder) {
